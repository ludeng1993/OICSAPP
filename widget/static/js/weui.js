...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	function gallery(url) {
		...
		$gallery.find('.weui-gallery__head').on('click', function () {
	        hide();
	    });
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"weui-gallery <%= className %>\"><div class=weui-gallery__head><i class=\"weui-icon-clear\"></i></div> <span class=weui-gallery__img style=\"background-image:url(<%= url %>)\"></span> <div class=weui-gallery__opr> <a href=javascript: class=weui-gallery__del> <i class=\"weui-icon-delete weui-icon_gallery-delete\"></i> </a> </div> </div> ";
